      ...
      <section className="relative overflow-hidden bg-[#070d2d] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <nav className="flex h-20 items-center justify-between">
            ...
            <a
              href="tel:+911234567899"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-rose-400 to-rose-500 px-4 py-2.5 text-xs font-bold text-white shadow-lg shadow-rose-950/30 transition hover:-translate-y-0.5 sm:px-5 sm:text-sm"
            >
          ...
          <div className="grid min-h-[650px] items-center gap-10 py-12 lg:grid-cols-[1fr_.9fr] lg:py-16">
            <div className="max-w-2xl">
              <span className="inline-flex items-center gap-2 text-[11px] font-extrabold uppercase tracking-[0.2em] text-rose-300">
                <span className="h-px w-8 bg-rose-400" />
                Real estate, reimagined
              </span>

              <h1
                className="mt-5 text-4xl font-black leading-[1.02] tracking-tight sm:text-5xl md:text-6xl"
                style={{ fontFamily: "'Poppins', sans-serif" }}
              >
                Making Real Estate
                <span className="block text-rose-400">Simple, Transparent</span>
                and Rewarding.
              </h1>

              <p className="mt-5 max-w-xl text-sm leading-7 text-white/65 sm:text-base">
                Trusted by buyers, families and investors who want verified
                properties, better prices and expert guidance without the noise.
              </p>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-rose-400 to-rose-500 px-6 py-3.5 font-bold text-white shadow-xl shadow-rose-950/30 transition hover:-translate-y-1"
                >
                  Explore Properties
                  <ChevronRight size={18} />
                </button>
